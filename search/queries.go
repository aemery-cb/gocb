...
func (q TermRangeQuery) MarshalJSON() ([]byte, error) {
	outStruct := &struct {
		...
		Inclusive_min *bool    `json:"inclusive_min,omitempty"`
		Max           *string  `json:"max,omitempty"`
		Inclusive_max *bool    `json:"inclusive_max,omitempty"`
		Boost         *float32 `json:"boost,omitempty"`
	}{
		Term:          q.term,
		Field:         q.field,
		Min:           q.min,
		Inclusive_min: q.inclusiveMin,
		Max:           q.max,
		Inclusive_max: q.inclusiveMax,
		Boost:         q.boost,
	}
